...
The deployment url is: [https://arquisoft.github.io/yovi_es5b/](https://arquisoft.github.io/yovi_es5b/).
...
If we want to deploy it to GitHub pages, so it is accessible via [https://arquisoft.github.io/yovi_es5b/](https://arquisoft.github.io/yovi_es5b/), we need to execute `npm run deploy`.
