...
// configure ES settings for asciidoc
include::src/config.adoc[]

= image:arc42-logo.png[arc42] yovi_es5b
:revnumber: 7.0 ES
:revdate: Enero 2017
:revremark: (basado en la versión de AsciiDoc)
...
<<<<
// 12. Pruebas usabilidad
include::src/13_pruebas_usabilidad.adoc[]
