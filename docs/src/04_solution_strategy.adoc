...
MySQL: junto al orm "sequelize npm" para la gestión de la base de datos relacional, facilitando las operaciones CRUD y la integración con el backend de usuarios.
