...
image::yovi_database.png[Base de datos de Yovi]
...
| `contraseña` | VARCHAR(255) | NOT NULL | Contraseña del usuario (hash)
|===
...
* *Almacenamiento de contraseñas*: El campo `contraseña` debe almacenar exclusivamente el hash de la contraseña. La responsabilidad del hasheo recae en la capa de servicio, no en el modelo.