...
=== Arquitectura de comunicación con gamey
...
Se tomó la decisión de utilizar una arquitectura cliente servidor sin estado; de esta forma, a gamey se le envía un movimiento a realizar y este responde su movimiento independientemente de jugadas anteriores en la partida.
...
No tener que gestionar el estado de la partida en gamey ayuda al desacoplamiento entre gamey y el cliente, pues gamey no necesita conocer el estado de movimientos de la partida para poder responder a las peticiones de juego.
También facilita la programación de bots, puesto que estos no necesitan acceder al estado de movimientos previos de la partida para dar su respuesta.
