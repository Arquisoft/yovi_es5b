...
=== Programación de bots basados en jugadas concretas

Por cómo se ha realizado la arquitectura de comunicación con el motor de juego, se complica el programa bots que necesiten el historial de jugadas concretas de una partida dada para calcular sus respuestas.
