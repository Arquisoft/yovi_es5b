  ...
  es: {
    translation: {
      ...
      auth: {
        ...
        password: 'Contraseña',
        passwordMinCharacters: 'Mínimo 8 caracteres',
      ...
      lobby: {
        ...
        boardCustom: 'Personalizado',
        boardCustomLabel: 'Tamaño del tablero: {{size}}',
        play: 'JUGAR',
  ...
  en: {
    translation: {
      ...
      auth: {
        ...
        username: 'Username',
        password: 'Password',
        passwordMinCharacters: 'Minimum 8 characters',
      ...
      lobby: {
        ...
        boardCustom: 'Custom',
        boardCustomLabel: 'Board size: {{size}}',
        play: 'PLAY',
  ...
  pt: {
    translation: {
      ...
      lobby: {
        ...
        boardCustom: 'Personalizado',
        boardCustomLabel: 'Tamanho do tabuleiro: {{size}}',
        play: 'JOGAR',
  ...
  fr: {
    translation: {
      ...
      lobby: {
        ...
        boardCustom: 'Personnalisé',
        boardCustomLabel: 'Taille du plateau : {{size}}',
        play: 'JOUER',
  ...
  de: {
    translation: {
      ...
      auth: {
        ...
        password: 'Passwort',
        passwordMinCharacters: 'Mindestens 8 Zeichen',
      ...
      lobby: {
        ...
        botLapa: 'Napfschnecke-Bot (Mittel)',
        ...
        boardCustom: 'Benutzerdefiniert',
        boardCustomLabel: 'Brettgröße: {{size}}',
        play: 'SPIELEN',
